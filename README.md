...
mamba activate ppl
python train.py \
    --cache-paths ~/project_dir/data/robotics/rlbench_imitation_learning \
...
- `--cache-paths`: one or more RLBench cache files or directories. Recursive discovery is supported.
